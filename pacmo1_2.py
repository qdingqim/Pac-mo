"""
CS 177 Group 17 Project Pac-mo Version 1.2
...
Todo:
    ...
    Time measure for each round
        - print the running time of each round at the end
...
def player_action(agent_host, world_state):
    walk_speed = 1
    turn = [0,90,180,-90]
    # implement as Q-learning
    return walk_speed, turn[random.randint(0, 3)]

def monster_action(block_coord, agent_host, grid, yaw):
    walk_speed = 0
    turn = 0
